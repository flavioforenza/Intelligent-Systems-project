...
that the model is robust across different datasets. Threshold-based selection 
of the object size is a method that still needs to be adapted to the type of 
scene.